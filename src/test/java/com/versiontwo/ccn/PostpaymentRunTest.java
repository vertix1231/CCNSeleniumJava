...
@CucumberOptions(features = "src/test/resources/features",
monochrome= true,
plugin = {"pretty", "junit:target/JUnitReports/reportgiropayment.xml",
		"json:target/JSONReports/reportgiropayment.json",
"html:target/HtmlReportgiropayment.html"},tags="@postpayment_ch")
public class PostpaymentRunTest {
