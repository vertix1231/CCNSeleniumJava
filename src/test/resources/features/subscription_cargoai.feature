Feature: CargoMart by CargoAi Product Plan

  @CargoMartbyCargoAiplan @e2e
  Scenario Outline: Subscribe CargoMart by CargoAi plan
    Given accept cookie
    ...
    Examples: 
      ...
      | sgqa-ccn-72920@mailinator.com | CCNPegasus123 | CargoMart by CargoAi |